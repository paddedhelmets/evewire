...
urlpatterns = [
    ...
    path('plans/<int:plan_id>/ignore-toggle/', views.skill_plan_ignore_toggle, name='skill_plan_ignore_toggle'),
    ...
    path('plans/<int:plan_id>/promote-prereq/<int:entry_id>/', views.skill_plan_promote_prereq, name='skill_plan_promote_prereq'),
    ...
    path('fittings/<int:fitting_id>/pin-toggle/', views.fitting_pin_toggle, name='fitting_pin_toggle'),
    path('fittings/<int:fitting_id>/readiness-browser/', views.fitting_readiness_browser, name='fitting_readiness_browser'),
    ...
    path('sde/constellation/<int:constellation_id>/', sde_views.sde_constellation_detail, name='sde_constellation_detail'),
    path('sde/region/<int:region_id>/', sde_views.sde_region_detail, name='sde_region_detail'),
    path('sde/station/<int:station_id>/', sde_views.sde_station_detail, name='sde_station_detail'),
